...
public class HelloController {
    ...
    // Los métodos de navegación (next, previous, last, first) no se pueden aplicar
    // directamente a un ObservableList. Se deberían implementar de forma diferente
    // si se quiere navegar por los registros de la base de datos de esa forma.
    // Una implementación más moderna y eficiente es trabajar con la tabla completa.
}
